...
public abstract class LightweaverShardplateBondableItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("radiant:lightweaver_shardplate_bondable"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public LightweaverShardplateBondableItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends LightweaverShardplateBondableItem {
		public Helmet() {
	...
	public static class Chestplate extends LightweaverShardplateBondableItem {
		public Chestplate() {
	...
	public static class Leggings extends LightweaverShardplateBondableItem {
		public Leggings() {
	...
	public static class Boots extends LightweaverShardplateBondableItem {
		public Boots() {
