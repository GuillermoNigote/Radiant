...
public abstract class WillshaperShardplateItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("radiant:willshaper_shardplate"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public WillshaperShardplateItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends WillshaperShardplateItem {
		public Helmet() {
	...
	public static class Chestplate extends WillshaperShardplateItem {
		public Chestplate() {
	...
	public static class Leggings extends WillshaperShardplateItem {
		public Leggings() {
	...
	public static class Boots extends WillshaperShardplateItem {
		public Boots() {
