...
@EventBusSubscriber
public class OthersWillDedicationManagerProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if (sourceentity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(RadiantModMobEffects.OTHERS_WILL_DEDICATION) || sourceentity instanceof LivingEntity _livEnt1 && _livEnt1.hasEffect(RadiantModMobEffects.OTHERS_WILL_DEDICATION_QUEST)) {
			if ((entity.getPersistentData().getString("master")).equals(sourceentity.getDisplayName().getString()) || (sourceentity.getPersistentData().getString("master")).equals(entity.getDisplayName().getString())) {
				{
				...
				if (sourceentity instanceof LivingEntity _entity)
					_entity.removeEffect(RadiantModMobEffects.OTHERS_WILL_DEDICATION_QUEST);
