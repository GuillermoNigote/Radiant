...
public abstract class EdgedancerShardplateItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("radiant:edgedancer_shardplate"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public EdgedancerShardplateItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends EdgedancerShardplateItem {
		public Helmet() {
	...
	public static class Chestplate extends EdgedancerShardplateItem {
		public Chestplate() {
	...
	public static class Leggings extends EdgedancerShardplateItem {
		public Leggings() {
	...
	public static class Boots extends EdgedancerShardplateItem {
		public Boots() {
