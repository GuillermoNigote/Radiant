...
public abstract class WindrunnerShardplateBondableItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("radiant:windrunner_shardplate_bondable"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public WindrunnerShardplateBondableItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends WindrunnerShardplateBondableItem {
		public Helmet() {
	...
	public static class Chestplate extends WindrunnerShardplateBondableItem {
		public Chestplate() {
	...
	public static class Leggings extends WindrunnerShardplateBondableItem {
		public Leggings() {
	...
	public static class Boots extends WindrunnerShardplateBondableItem {
		public Boots() {
