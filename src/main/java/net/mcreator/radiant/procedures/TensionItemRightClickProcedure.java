...
public class TensionItemRightClickProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.WOODEN_AXE) {
			...
			if (entity instanceof Player _player)
				_player.giveExperiencePoints(-(1));
		} else if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.WOODEN_SHOVEL) {
			damage = (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getDamageValue();
			if (entity instanceof LivingEntity _entity) {
			...
			if (entity instanceof Player _player)
				_player.giveExperiencePoints(-(10));
		} else if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.STRING) {
			if (entity instanceof LivingEntity _entity) {
				ItemStack _setstack = new ItemStack(RadiantModItems.TENSION_STRING.get()).copy();
				_setstack.setCount(1);
				_entity.setItemInHand(InteractionHand.MAIN_HAND, _setstack);
				if (_entity instanceof Player _player)
					_player.getInventory().setChanged();
			...
			if (entity instanceof Player _player)
				_player.giveExperiencePoints(-(5));
		} else if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.LEAD) {
			if (entity instanceof LivingEntity _entity) {
				ItemStack _setstack = new ItemStack(RadiantModItems.TENSION_LEAD.get()).copy();
				_setstack.setCount(1);
				_entity.setItemInHand(InteractionHand.MAIN_HAND, _setstack);
				if (_entity instanceof Player _player)
					_player.getInventory().setChanged();
