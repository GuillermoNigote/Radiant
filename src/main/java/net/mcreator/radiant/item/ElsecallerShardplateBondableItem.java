...
public abstract class ElsecallerShardplateBondableItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("entity.experience_orb.pickup")), () -> Ingredient.of(), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("radiant:elsecaller_shardplate"))), 3f, 0.1f);
			registerHelper.register(ResourceLocation.parse("radiant:elsecaller_shardplate_bondable"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public ElsecallerShardplateBondableItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends ElsecallerShardplateBondableItem {
		public Helmet() {
	...
	public static class Chestplate extends ElsecallerShardplateBondableItem {
		public Chestplate() {
	...
	public static class Leggings extends ElsecallerShardplateBondableItem {
		public Leggings() {
	...
	public static class Boots extends ElsecallerShardplateBondableItem {
		public Boots() {
