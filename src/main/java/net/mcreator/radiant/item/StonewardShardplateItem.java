...
public abstract class StonewardShardplateItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("radiant:stoneward_shardplate"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public StonewardShardplateItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends StonewardShardplateItem {
		public Helmet() {
	...
	public static class Chestplate extends StonewardShardplateItem {
		public Chestplate() {
	...
	public static class Leggings extends StonewardShardplateItem {
		public Leggings() {
	...
	public static class Boots extends StonewardShardplateItem {
		public Boots() {
