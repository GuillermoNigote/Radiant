...
public class VeganDedicationOnEffectActiveTickProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(RadiantModMobEffects.VEGAN_DEDICATION_QUEST) ? _livEnt.getEffect(RadiantModMobEffects.VEGAN_DEDICATION_QUEST).getDuration() : 0) == 1) {
			{
				Entity _ent = entity;
