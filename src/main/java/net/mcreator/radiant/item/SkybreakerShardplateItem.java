...
public abstract class SkybreakerShardplateItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("radiant:skybreaker_shardplate"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public SkybreakerShardplateItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends SkybreakerShardplateItem {
		public Helmet() {
	...
	public static class Leggings extends SkybreakerShardplateItem {
		public Leggings() {
