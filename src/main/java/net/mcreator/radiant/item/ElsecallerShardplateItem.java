...
public abstract class ElsecallerShardplateItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("radiant:elsecaller_shardplate"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public ElsecallerShardplateItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends ElsecallerShardplateItem {
		public Helmet() {
	...
	public static class Chestplate extends ElsecallerShardplateItem {
		public Chestplate() {
	...
	public static class Leggings extends ElsecallerShardplateItem {
		public Leggings() {
	...
	public static class Boots extends ElsecallerShardplateItem {
		public Boots() {
