...
public abstract class EdgedancerShardplateBondableItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("entity.experience_orb.pickup")), () -> Ingredient.of(), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("radiant:edgedancer_shardplate"))), 3f, 0.1f);
			registerHelper.register(ResourceLocation.parse("radiant:edgedancer_shardplate_bondable"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public EdgedancerShardplateBondableItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends EdgedancerShardplateBondableItem {
		public Helmet() {
	...
	public static class Chestplate extends EdgedancerShardplateBondableItem {
		public Chestplate() {
	...
	public static class Leggings extends EdgedancerShardplateBondableItem {
		public Leggings() {
	...
	public static class Boots extends EdgedancerShardplateBondableItem {
		public Boots() {
