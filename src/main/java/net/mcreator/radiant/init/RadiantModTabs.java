...
public class RadiantModTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> RADIANT = REGISTRY.register("radiant",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.radiant.radiant")).icon(() -> new ItemStack(RadiantModItems.RADIANTS_GLYPH.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(RadiantModItems.WINDRUNNER_SHARDPLATE_HELMET.get());
				tabData.accept(RadiantModItems.WINDRUNNER_SHARDPLATE_CHESTPLATE.get());
				tabData.accept(RadiantModItems.WINDRUNNER_SHARDPLATE_LEGGINGS.get());
				tabData.accept(RadiantModItems.WINDRUNNER_SHARDPLATE_BOOTS.get());
				tabData.accept(RadiantModItems.SKYBREAKER_SHARDPLATE_HELMET.get());
				tabData.accept(RadiantModItems.SKYBREAKER_SHARDPLATE_CHESTPLATE.get());
				tabData.accept(RadiantModItems.SKYBREAKER_SHARDPLATE_LEGGINGS.get());
				tabData.accept(RadiantModItems.SKYBREAKER_SHARDPLATE_BOOTS.get());
				...
				tabData.accept(RadiantModItems.EDGEDANCER_SHARDPLATE_HELMET.get());
				tabData.accept(RadiantModItems.EDGEDANCER_SHARDPLATE_CHESTPLATE.get());
				tabData.accept(RadiantModItems.EDGEDANCER_SHARDPLATE_LEGGINGS.get());
				tabData.accept(RadiantModItems.EDGEDANCER_SHARDPLATE_BOOTS.get());
				tabData.accept(RadiantModItems.TRUTHWATCHER_SHARDPLATE_HELMET.get());
				tabData.accept(RadiantModItems.TRUTHWATCHER_SHARDPLATE_CHESTPLATE.get());
				tabData.accept(RadiantModItems.TRUTHWATCHER_SHARDPLATE_LEGGINGS.get());
				tabData.accept(RadiantModItems.TRUTHWATCHER_SHARDPLATE_BOOTS.get());
				tabData.accept(RadiantModItems.LIGHTWEAVER_SHARDPLATE_HELMET.get());
				tabData.accept(RadiantModItems.LIGHTWEAVER_SHARDPLATE_CHESTPLATE.get());
				tabData.accept(RadiantModItems.LIGHTWEAVER_SHARDPLATE_LEGGINGS.get());
				tabData.accept(RadiantModItems.LIGHTWEAVER_SHARDPLATE_BOOTS.get());
				tabData.accept(RadiantModItems.ELSECALLER_SHARDPLATE_HELMET.get());
				tabData.accept(RadiantModItems.ELSECALLER_SHARDPLATE_CHESTPLATE.get());
				tabData.accept(RadiantModItems.ELSECALLER_SHARDPLATE_LEGGINGS.get());
				tabData.accept(RadiantModItems.ELSECALLER_SHARDPLATE_BOOTS.get());
				tabData.accept(RadiantModItems.WILLSHAPER_SHARDPLATE_HELMET.get());
				tabData.accept(RadiantModItems.WILLSHAPER_SHARDPLATE_CHESTPLATE.get());
				tabData.accept(RadiantModItems.WILLSHAPER_SHARDPLATE_LEGGINGS.get());
				tabData.accept(RadiantModItems.WILLSHAPER_SHARDPLATE_BOOTS.get());
				tabData.accept(RadiantModItems.STONEWARD_SHARDPLATE_HELMET.get());
				tabData.accept(RadiantModItems.STONEWARD_SHARDPLATE_CHESTPLATE.get());
