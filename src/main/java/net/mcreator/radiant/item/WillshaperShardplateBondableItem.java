...
public abstract class WillshaperShardplateBondableItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("entity.experience_orb.pickup")), () -> Ingredient.of(), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("radiant:willshaper_shardplate"))), 3f, 0.1f);
			registerHelper.register(ResourceLocation.parse("radiant:willshaper_shardplate_bondable"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public WillshaperShardplateBondableItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends WillshaperShardplateBondableItem {
		public Helmet() {
	...
	public static class Chestplate extends WillshaperShardplateBondableItem {
		public Chestplate() {
	...
	public static class Leggings extends WillshaperShardplateBondableItem {
		public Leggings() {
	...
	public static class Boots extends WillshaperShardplateBondableItem {
		public Boots() {
