...
public class TensionTurtleArmorHelmetTickEventProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (!(entity instanceof LivingEntity _livEnt1 && _livEnt1.hasEffect(RadiantModMobEffects.INFUSED_ARMOR))) {
			if (entity instanceof LivingEntity _livEnt2 && _livEnt2.hasEffect(RadiantModMobEffects.TENSION_STONEWARD) && (entity instanceof Player _plr ? _plr.experienceLevel : 0) >= 2) {
