...
@EventBusSubscriber
public class LawDedicationManagerProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if (sourceentity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(RadiantModMobEffects.LAW_DEDICATION_QUEST) || sourceentity instanceof LivingEntity _livEnt1 && _livEnt1.hasEffect(RadiantModMobEffects.LAW_DEDICATION)) {
			if (entity instanceof WanderingTrader || entity instanceof Villager || entity instanceof IronGolem || entity instanceof Piglin) {
				{
