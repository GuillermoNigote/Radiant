...
import net.mcreator.radiant.item.WindrunnerShardplateItem;
import net.mcreator.radiant.item.WindrunnerShardplateBondableItem;
...
import net.mcreator.radiant.item.WindrunnerEmeraldBondableShardbladeItem;
import net.mcreator.radiant.item.WindrunnerDiamondBondableShardbladeItem;
import net.mcreator.radiant.item.WindrunnerDeadShardbladeItem;
import net.mcreator.radiant.item.WindrunnerAmethystBondableShardbladeItem;
...
import net.mcreator.radiant.item.WillshaperShardplateItem;
import net.mcreator.radiant.item.WillshaperShardplateBondableItem;
import net.mcreator.radiant.item.WillshaperLivingShardbladeItem;
import net.mcreator.radiant.item.WillshaperEmeraldBondableShardbladeItem;
import net.mcreator.radiant.item.WillshaperDiamondBondableShardbladeItem;
...
import net.mcreator.radiant.item.WillshaperAmethystBondableShardbladeItem;
import net.mcreator.radiant.item.TruthwatchersGlyphItem;
import net.mcreator.radiant.item.TruthwatcherShardplateItem;
import net.mcreator.radiant.item.TruthwatcherShardplateBondableItem;
...
import net.mcreator.radiant.item.TruthwatcherEmeraldBondableShardbladeItem;
import net.mcreator.radiant.item.TruthwatcherDiamondBondableShardbladeItem;
import net.mcreator.radiant.item.TruthwatcherDeadShardbladeItem;
import net.mcreator.radiant.item.TruthwatcherAmethystBondableShardbladeItem;
...
import net.mcreator.radiant.item.TensionStringItem;
...
import net.mcreator.radiant.item.TensionLeadItem;
...
import net.mcreator.radiant.item.StonewardShardplateItem;
import net.mcreator.radiant.item.StonewardShardplateBondableItem;
import net.mcreator.radiant.item.StonewardLivingShardbladeItem;
import net.mcreator.radiant.item.StonewardEmeraldBondableShardbladeItem;
import net.mcreator.radiant.item.StonewardDiamondBondableShardbladeItem;
import net.mcreator.radiant.item.StonewardDeadShardbladeItem;
import net.mcreator.radiant.item.StonewardCohesionGlyphItem;
import net.mcreator.radiant.item.StonewardAmethystBondableShardbladeItem;
import net.mcreator.radiant.item.SkybreakersGlyphItem;
import net.mcreator.radiant.item.SkybreakerShardplateItem;
import net.mcreator.radiant.item.SkybreakerShardplateBondableItem;
...
import net.mcreator.radiant.item.SkybreakerEmeraldBondableShardbladeItem;
import net.mcreator.radiant.item.SkybreakerDivisionGlyphItem;
import net.mcreator.radiant.item.SkybreakerDiamondBondableShardbladeItem;
import net.mcreator.radiant.item.SkybreakerDeadShardbladeItem;
import net.mcreator.radiant.item.SkybreakerAmethystBondableShardbladeItem;
...
import net.mcreator.radiant.item.LightweaverShardplateItem;
import net.mcreator.radiant.item.LightweaverShardplateBondableItem;
...
import net.mcreator.radiant.item.LightweaverEmeraldBondableShardbladeItem;
import net.mcreator.radiant.item.LightweaverDiamondBondableShardbladeItem;
import net.mcreator.radiant.item.LightweaverDeadShardbladeItem;
import net.mcreator.radiant.item.LightweaverAmethystBondableShardbladeItem;
import net.mcreator.radiant.item.InfusedEmeraldItem;
import net.mcreator.radiant.item.InfusedDiamondItem;
import net.mcreator.radiant.item.InfusedAmethystItem;
...
import net.mcreator.radiant.item.ElsecallerShardplateItem;
import net.mcreator.radiant.item.ElsecallerShardplateBondableItem;
import net.mcreator.radiant.item.ElsecallerLivingShardbladeItem;
import net.mcreator.radiant.item.ElsecallerEmeraldBondableShardbladeItem;
import net.mcreator.radiant.item.ElsecallerDiamondBondableShardbladeItem;
import net.mcreator.radiant.item.ElsecallerDeadShardbladeItem;
import net.mcreator.radiant.item.ElsecallerAmethystBondableShardbladeItem;
import net.mcreator.radiant.item.EdgedancersGlyphItem;
import net.mcreator.radiant.item.EdgedancerShardplateItem;
import net.mcreator.radiant.item.EdgedancerShardplateBondableItem;
...
import net.mcreator.radiant.item.EdgedancerEmeraldBondableShardbladeItem;
import net.mcreator.radiant.item.EdgedancerDiamondBondableShardbladeItem;
import net.mcreator.radiant.item.EdgedancerDeadShardbladeItem;
import net.mcreator.radiant.item.EdgedancerAmethystBondableShardbladeItem;
...
import net.mcreator.radiant.item.DustbringerShardplateBondableItem;
import net.mcreator.radiant.item.DustbringerLivingShardbladeItem;
import net.mcreator.radiant.item.DustbringerEmeraldBondableShardbladeItem;
import net.mcreator.radiant.item.DustbringerDivisionGlyphItem;
import net.mcreator.radiant.item.DustbringerDiamondBondableShardbladeItem;
import net.mcreator.radiant.item.DustbringerDeadShardbladeItem;
import net.mcreator.radiant.item.DustbringerAmethystBondableShardbladeItem;
...
public class RadiantModItems {
	...
	public static final DeferredItem<Item> WINDRUNNER_SHARDPLATE_HELMET = REGISTRY.register("windrunner_shardplate_helmet", WindrunnerShardplateItem.Helmet::new);
	public static final DeferredItem<Item> WINDRUNNER_SHARDPLATE_CHESTPLATE = REGISTRY.register("windrunner_shardplate_chestplate", WindrunnerShardplateItem.Chestplate::new);
	public static final DeferredItem<Item> WINDRUNNER_SHARDPLATE_LEGGINGS = REGISTRY.register("windrunner_shardplate_leggings", WindrunnerShardplateItem.Leggings::new);
	public static final DeferredItem<Item> WINDRUNNER_SHARDPLATE_BOOTS = REGISTRY.register("windrunner_shardplate_boots", WindrunnerShardplateItem.Boots::new);
	public static final DeferredItem<Item> SKYBREAKER_SHARDPLATE_HELMET = REGISTRY.register("skybreaker_shardplate_helmet", SkybreakerShardplateItem.Helmet::new);
	public static final DeferredItem<Item> SKYBREAKER_SHARDPLATE_CHESTPLATE = REGISTRY.register("skybreaker_shardplate_chestplate", SkybreakerShardplateItem.Chestplate::new);
	public static final DeferredItem<Item> SKYBREAKER_SHARDPLATE_LEGGINGS = REGISTRY.register("skybreaker_shardplate_leggings", SkybreakerShardplateItem.Leggings::new);
	public static final DeferredItem<Item> SKYBREAKER_SHARDPLATE_BOOTS = REGISTRY.register("skybreaker_shardplate_boots", SkybreakerShardplateItem.Boots::new);
	...
	public static final DeferredItem<Item> EDGEDANCER_SHARDPLATE_HELMET = REGISTRY.register("edgedancer_shardplate_helmet", EdgedancerShardplateItem.Helmet::new);
	public static final DeferredItem<Item> EDGEDANCER_SHARDPLATE_CHESTPLATE = REGISTRY.register("edgedancer_shardplate_chestplate", EdgedancerShardplateItem.Chestplate::new);
	public static final DeferredItem<Item> EDGEDANCER_SHARDPLATE_LEGGINGS = REGISTRY.register("edgedancer_shardplate_leggings", EdgedancerShardplateItem.Leggings::new);
	public static final DeferredItem<Item> EDGEDANCER_SHARDPLATE_BOOTS = REGISTRY.register("edgedancer_shardplate_boots", EdgedancerShardplateItem.Boots::new);
	public static final DeferredItem<Item> TRUTHWATCHER_SHARDPLATE_HELMET = REGISTRY.register("truthwatcher_shardplate_helmet", TruthwatcherShardplateItem.Helmet::new);
	public static final DeferredItem<Item> TRUTHWATCHER_SHARDPLATE_CHESTPLATE = REGISTRY.register("truthwatcher_shardplate_chestplate", TruthwatcherShardplateItem.Chestplate::new);
	public static final DeferredItem<Item> TRUTHWATCHER_SHARDPLATE_LEGGINGS = REGISTRY.register("truthwatcher_shardplate_leggings", TruthwatcherShardplateItem.Leggings::new);
	public static final DeferredItem<Item> TRUTHWATCHER_SHARDPLATE_BOOTS = REGISTRY.register("truthwatcher_shardplate_boots", TruthwatcherShardplateItem.Boots::new);
	public static final DeferredItem<Item> LIGHTWEAVER_SHARDPLATE_HELMET = REGISTRY.register("lightweaver_shardplate_helmet", LightweaverShardplateItem.Helmet::new);
	public static final DeferredItem<Item> LIGHTWEAVER_SHARDPLATE_CHESTPLATE = REGISTRY.register("lightweaver_shardplate_chestplate", LightweaverShardplateItem.Chestplate::new);
	public static final DeferredItem<Item> LIGHTWEAVER_SHARDPLATE_LEGGINGS = REGISTRY.register("lightweaver_shardplate_leggings", LightweaverShardplateItem.Leggings::new);
	public static final DeferredItem<Item> LIGHTWEAVER_SHARDPLATE_BOOTS = REGISTRY.register("lightweaver_shardplate_boots", LightweaverShardplateItem.Boots::new);
	public static final DeferredItem<Item> ELSECALLER_SHARDPLATE_HELMET = REGISTRY.register("elsecaller_shardplate_helmet", ElsecallerShardplateItem.Helmet::new);
	public static final DeferredItem<Item> ELSECALLER_SHARDPLATE_CHESTPLATE = REGISTRY.register("elsecaller_shardplate_chestplate", ElsecallerShardplateItem.Chestplate::new);
	public static final DeferredItem<Item> ELSECALLER_SHARDPLATE_LEGGINGS = REGISTRY.register("elsecaller_shardplate_leggings", ElsecallerShardplateItem.Leggings::new);
	public static final DeferredItem<Item> ELSECALLER_SHARDPLATE_BOOTS = REGISTRY.register("elsecaller_shardplate_boots", ElsecallerShardplateItem.Boots::new);
	public static final DeferredItem<Item> WILLSHAPER_SHARDPLATE_HELMET = REGISTRY.register("willshaper_shardplate_helmet", WillshaperShardplateItem.Helmet::new);
	public static final DeferredItem<Item> WILLSHAPER_SHARDPLATE_CHESTPLATE = REGISTRY.register("willshaper_shardplate_chestplate", WillshaperShardplateItem.Chestplate::new);
	public static final DeferredItem<Item> WILLSHAPER_SHARDPLATE_LEGGINGS = REGISTRY.register("willshaper_shardplate_leggings", WillshaperShardplateItem.Leggings::new);
	public static final DeferredItem<Item> WILLSHAPER_SHARDPLATE_BOOTS = REGISTRY.register("willshaper_shardplate_boots", WillshaperShardplateItem.Boots::new);
	public static final DeferredItem<Item> STONEWARD_SHARDPLATE_HELMET = REGISTRY.register("stoneward_shardplate_helmet", StonewardShardplateItem.Helmet::new);
	public static final DeferredItem<Item> STONEWARD_SHARDPLATE_CHESTPLATE = REGISTRY.register("stoneward_shardplate_chestplate", StonewardShardplateItem.Chestplate::new);
	public static final DeferredItem<Item> STONEWARD_SHARDPLATE_LEGGINGS = REGISTRY.register("stoneward_shardplate_leggings", StonewardShardplateItem.Leggings::new);
	public static final DeferredItem<Item> STONEWARD_SHARDPLATE_BOOTS = REGISTRY.register("stoneward_shardplate_boots", StonewardShardplateItem.Boots::new);
	...
	public static final DeferredItem<Item> ELSECALLER_DEAD_SHARDBLADE = REGISTRY.register("elsecaller_dead_shardblade", ElsecallerDeadShardbladeItem::new);
	public static final DeferredItem<Item> DUSTBRINGER_EMERALD_BONDABLE_SHARDBLADE = REGISTRY.register("dustbringer_emerald_bondable_shardblade", DustbringerEmeraldBondableShardbladeItem::new);
	public static final DeferredItem<Item> DUSTBRINGER_DIAMOND_BONDABLE_SHARDBLADE = REGISTRY.register("dustbringer_diamond_bondable_shardblade", DustbringerDiamondBondableShardbladeItem::new);
	public static final DeferredItem<Item> EDGEDANCER_EMERALD_BONDABLE_SHARDBLADE = REGISTRY.register("edgedancer_emerald_bondable_shardblade", EdgedancerEmeraldBondableShardbladeItem::new);
	public static final DeferredItem<Item> EDGEDANCER_DIAMOND_BONDABLE_SHARDBLADE = REGISTRY.register("edgedancer_diamond_bondable_shardblade", EdgedancerDiamondBondableShardbladeItem::new);
	public static final DeferredItem<Item> SKYBREAKER_DIAMOND_BONDABLE_SHARDBLADE = REGISTRY.register("skybreaker_diamond_bondable_shardblade", SkybreakerDiamondBondableShardbladeItem::new);
	public static final DeferredItem<Item> SKYBREAKER_EMERALD_BONDABLE_SHARDBLADE = REGISTRY.register("skybreaker_emerald_bondable_shardblade", SkybreakerEmeraldBondableShardbladeItem::new);
	public static final DeferredItem<Item> WINDRUNNER_EMERALD_BONDABLE_SHARDBLADE = REGISTRY.register("windrunner_emerald_bondable_shardblade", WindrunnerEmeraldBondableShardbladeItem::new);
	public static final DeferredItem<Item> WINDRUNNER_DIAMOND_BONDABLE_SHARDBLADE = REGISTRY.register("windrunner_diamond_bondable_shardblade", WindrunnerDiamondBondableShardbladeItem::new);
	public static final DeferredItem<Item> TRUTHWATCHER_DIAMOND_BONDABLE_SHARDBLADE = REGISTRY.register("truthwatcher_diamond_bondable_shardblade", TruthwatcherDiamondBondableShardbladeItem::new);
	public static final DeferredItem<Item> TRUTHWATCHER_EMERALD_BONDABLE_SHARDBLADE = REGISTRY.register("truthwatcher_emerald_bondable_shardblade", TruthwatcherEmeraldBondableShardbladeItem::new);
	public static final DeferredItem<Item> LIGHTWEAVER_DIAMOND_BONDABLE_SHARDBLADE = REGISTRY.register("lightweaver_diamond_bondable_shardblade", LightweaverDiamondBondableShardbladeItem::new);
	public static final DeferredItem<Item> LIGHTWEAVER_EMERALD_BONDABLE_SHARDBLADE = REGISTRY.register("lightweaver_emerald_bondable_shardblade", LightweaverEmeraldBondableShardbladeItem::new);
	public static final DeferredItem<Item> WILLSHAPER_DIAMOND_BONDABLE_SHARDBLADE = REGISTRY.register("willshaper_diamond_bondable_shardblade", WillshaperDiamondBondableShardbladeItem::new);
	public static final DeferredItem<Item> WILLSHAPER_EMERALD_BONDABLE_SHARDBLADE = REGISTRY.register("willshaper_emerald_bondable_shardblade", WillshaperEmeraldBondableShardbladeItem::new);
	public static final DeferredItem<Item> STONEWARD_EMERALD_BONDABLE_SHARDBLADE = REGISTRY.register("stoneward_emerald_bondable_shardblade", StonewardEmeraldBondableShardbladeItem::new);
	public static final DeferredItem<Item> STONEWARD_DIAMOND_BONDABLE_SHARDBLADE = REGISTRY.register("stoneward_diamond_bondable_shardblade", StonewardDiamondBondableShardbladeItem::new);
	public static final DeferredItem<Item> ELSECALLER_EMERALD_BONDABLE_SHARDBLADE = REGISTRY.register("elsecaller_emerald_bondable_shardblade", ElsecallerEmeraldBondableShardbladeItem::new);
	public static final DeferredItem<Item> ELSECALLER_DIAMOND_BONDABLE_SHARDBLADE = REGISTRY.register("elsecaller_diamond_bondable_shardblade", ElsecallerDiamondBondableShardbladeItem::new);
	public static final DeferredItem<Item> INFUSED_AMETHYST = REGISTRY.register("infused_amethyst", InfusedAmethystItem::new);
	public static final DeferredItem<Item> DUSTBRINGER_AMETHYST_BONDABLE_SHARDBLADE = REGISTRY.register("dustbringer_amethyst_bondable_shardblade", DustbringerAmethystBondableShardbladeItem::new);
	public static final DeferredItem<Item> EDGEDANCER_AMETHYST_BONDABLE_SHARDBLADE = REGISTRY.register("edgedancer_amethyst_bondable_shardblade", EdgedancerAmethystBondableShardbladeItem::new);
	public static final DeferredItem<Item> SKYBREAKER_AMETHYST_BONDABLE_SHARDBLADE = REGISTRY.register("skybreaker_amethyst_bondable_shardblade", SkybreakerAmethystBondableShardbladeItem::new);
	public static final DeferredItem<Item> WINDRUNNER_AMETHYST_BONDABLE_SHARDBLADE = REGISTRY.register("windrunner_amethyst_bondable_shardblade", WindrunnerAmethystBondableShardbladeItem::new);
	public static final DeferredItem<Item> TRUTHWATCHER_AMETHYST_BONDABLE_SHARDBLADE = REGISTRY.register("truthwatcher_amethyst_bondable_shardblade", TruthwatcherAmethystBondableShardbladeItem::new);
	public static final DeferredItem<Item> LIGHTWEAVER_AMETHYST_BONDABLE_SHARDBLADE = REGISTRY.register("lightweaver_amethyst_bondable_shardblade", LightweaverAmethystBondableShardbladeItem::new);
	public static final DeferredItem<Item> WILLSHAPER_AMETHYST_BONDABLE_SHARDBLADE = REGISTRY.register("willshaper_amethyst_bondable_shardblade", WillshaperAmethystBondableShardbladeItem::new);
	public static final DeferredItem<Item> STONEWARD_AMETHYST_BONDABLE_SHARDBLADE = REGISTRY.register("stoneward_amethyst_bondable_shardblade", StonewardAmethystBondableShardbladeItem::new);
	public static final DeferredItem<Item> ELSECALLER_AMETHYST_BONDABLE_SHARDBLADE = REGISTRY.register("elsecaller_amethyst_bondable_shardblade", ElsecallerAmethystBondableShardbladeItem::new);
	public static final DeferredItem<Item> WINDRUNNER_SHARDPLATE_BONDABLE_HELMET = REGISTRY.register("windrunner_shardplate_bondable_helmet", WindrunnerShardplateBondableItem.Helmet::new);
	public static final DeferredItem<Item> WINDRUNNER_SHARDPLATE_BONDABLE_CHESTPLATE = REGISTRY.register("windrunner_shardplate_bondable_chestplate", WindrunnerShardplateBondableItem.Chestplate::new);
	public static final DeferredItem<Item> WINDRUNNER_SHARDPLATE_BONDABLE_LEGGINGS = REGISTRY.register("windrunner_shardplate_bondable_leggings", WindrunnerShardplateBondableItem.Leggings::new);
	public static final DeferredItem<Item> WINDRUNNER_SHARDPLATE_BONDABLE_BOOTS = REGISTRY.register("windrunner_shardplate_bondable_boots", WindrunnerShardplateBondableItem.Boots::new);
	public static final DeferredItem<Item> SKYBREAKER_SHARDPLATE_BONDABLE_HELMET = REGISTRY.register("skybreaker_shardplate_bondable_helmet", SkybreakerShardplateBondableItem.Helmet::new);
	public static final DeferredItem<Item> SKYBREAKER_SHARDPLATE_BONDABLE_CHESTPLATE = REGISTRY.register("skybreaker_shardplate_bondable_chestplate", SkybreakerShardplateBondableItem.Chestplate::new);
	public static final DeferredItem<Item> SKYBREAKER_SHARDPLATE_BONDABLE_LEGGINGS = REGISTRY.register("skybreaker_shardplate_bondable_leggings", SkybreakerShardplateBondableItem.Leggings::new);
	public static final DeferredItem<Item> SKYBREAKER_SHARDPLATE_BONDABLE_BOOTS = REGISTRY.register("skybreaker_shardplate_bondable_boots", SkybreakerShardplateBondableItem.Boots::new);
	public static final DeferredItem<Item> DUSTBRINGER_SHARDPLATE_BONDABLE_HELMET = REGISTRY.register("dustbringer_shardplate_bondable_helmet", DustbringerShardplateBondableItem.Helmet::new);
	public static final DeferredItem<Item> DUSTBRINGER_SHARDPLATE_BONDABLE_CHESTPLATE = REGISTRY.register("dustbringer_shardplate_bondable_chestplate", DustbringerShardplateBondableItem.Chestplate::new);
	public static final DeferredItem<Item> DUSTBRINGER_SHARDPLATE_BONDABLE_LEGGINGS = REGISTRY.register("dustbringer_shardplate_bondable_leggings", DustbringerShardplateBondableItem.Leggings::new);
	public static final DeferredItem<Item> DUSTBRINGER_SHARDPLATE_BONDABLE_BOOTS = REGISTRY.register("dustbringer_shardplate_bondable_boots", DustbringerShardplateBondableItem.Boots::new);
	public static final DeferredItem<Item> EDGEDANCER_SHARDPLATE_BONDABLE_HELMET = REGISTRY.register("edgedancer_shardplate_bondable_helmet", EdgedancerShardplateBondableItem.Helmet::new);
	public static final DeferredItem<Item> EDGEDANCER_SHARDPLATE_BONDABLE_CHESTPLATE = REGISTRY.register("edgedancer_shardplate_bondable_chestplate", EdgedancerShardplateBondableItem.Chestplate::new);
	public static final DeferredItem<Item> EDGEDANCER_SHARDPLATE_BONDABLE_LEGGINGS = REGISTRY.register("edgedancer_shardplate_bondable_leggings", EdgedancerShardplateBondableItem.Leggings::new);
	public static final DeferredItem<Item> EDGEDANCER_SHARDPLATE_BONDABLE_BOOTS = REGISTRY.register("edgedancer_shardplate_bondable_boots", EdgedancerShardplateBondableItem.Boots::new);
	public static final DeferredItem<Item> TRUTHWATCHER_SHARDPLATE_BONDABLE_HELMET = REGISTRY.register("truthwatcher_shardplate_bondable_helmet", TruthwatcherShardplateBondableItem.Helmet::new);
	public static final DeferredItem<Item> TRUTHWATCHER_SHARDPLATE_BONDABLE_CHESTPLATE = REGISTRY.register("truthwatcher_shardplate_bondable_chestplate", TruthwatcherShardplateBondableItem.Chestplate::new);
	public static final DeferredItem<Item> TRUTHWATCHER_SHARDPLATE_BONDABLE_LEGGINGS = REGISTRY.register("truthwatcher_shardplate_bondable_leggings", TruthwatcherShardplateBondableItem.Leggings::new);
	public static final DeferredItem<Item> TRUTHWATCHER_SHARDPLATE_BONDABLE_BOOTS = REGISTRY.register("truthwatcher_shardplate_bondable_boots", TruthwatcherShardplateBondableItem.Boots::new);
	public static final DeferredItem<Item> LIGHTWEAVER_SHARDPLATE_BONDABLE_HELMET = REGISTRY.register("lightweaver_shardplate_bondable_helmet", LightweaverShardplateBondableItem.Helmet::new);
	public static final DeferredItem<Item> LIGHTWEAVER_SHARDPLATE_BONDABLE_CHESTPLATE = REGISTRY.register("lightweaver_shardplate_bondable_chestplate", LightweaverShardplateBondableItem.Chestplate::new);
	public static final DeferredItem<Item> LIGHTWEAVER_SHARDPLATE_BONDABLE_LEGGINGS = REGISTRY.register("lightweaver_shardplate_bondable_leggings", LightweaverShardplateBondableItem.Leggings::new);
	public static final DeferredItem<Item> LIGHTWEAVER_SHARDPLATE_BONDABLE_BOOTS = REGISTRY.register("lightweaver_shardplate_bondable_boots", LightweaverShardplateBondableItem.Boots::new);
	public static final DeferredItem<Item> ELSECALLER_SHARDPLATE_BONDABLE_HELMET = REGISTRY.register("elsecaller_shardplate_bondable_helmet", ElsecallerShardplateBondableItem.Helmet::new);
	public static final DeferredItem<Item> ELSECALLER_SHARDPLATE_BONDABLE_CHESTPLATE = REGISTRY.register("elsecaller_shardplate_bondable_chestplate", ElsecallerShardplateBondableItem.Chestplate::new);
	public static final DeferredItem<Item> ELSECALLER_SHARDPLATE_BONDABLE_LEGGINGS = REGISTRY.register("elsecaller_shardplate_bondable_leggings", ElsecallerShardplateBondableItem.Leggings::new);
	public static final DeferredItem<Item> ELSECALLER_SHARDPLATE_BONDABLE_BOOTS = REGISTRY.register("elsecaller_shardplate_bondable_boots", ElsecallerShardplateBondableItem.Boots::new);
	public static final DeferredItem<Item> WILLSHAPER_SHARDPLATE_BONDABLE_HELMET = REGISTRY.register("willshaper_shardplate_bondable_helmet", WillshaperShardplateBondableItem.Helmet::new);
	public static final DeferredItem<Item> WILLSHAPER_SHARDPLATE_BONDABLE_CHESTPLATE = REGISTRY.register("willshaper_shardplate_bondable_chestplate", WillshaperShardplateBondableItem.Chestplate::new);
	public static final DeferredItem<Item> WILLSHAPER_SHARDPLATE_BONDABLE_LEGGINGS = REGISTRY.register("willshaper_shardplate_bondable_leggings", WillshaperShardplateBondableItem.Leggings::new);
	public static final DeferredItem<Item> WILLSHAPER_SHARDPLATE_BONDABLE_BOOTS = REGISTRY.register("willshaper_shardplate_bondable_boots", WillshaperShardplateBondableItem.Boots::new);
	public static final DeferredItem<Item> STONEWARD_SHARDPLATE_BONDABLE_HELMET = REGISTRY.register("stoneward_shardplate_bondable_helmet", StonewardShardplateBondableItem.Helmet::new);
	public static final DeferredItem<Item> STONEWARD_SHARDPLATE_BONDABLE_CHESTPLATE = REGISTRY.register("stoneward_shardplate_bondable_chestplate", StonewardShardplateBondableItem.Chestplate::new);
	public static final DeferredItem<Item> STONEWARD_SHARDPLATE_BONDABLE_LEGGINGS = REGISTRY.register("stoneward_shardplate_bondable_leggings", StonewardShardplateBondableItem.Leggings::new);
	public static final DeferredItem<Item> STONEWARD_SHARDPLATE_BONDABLE_BOOTS = REGISTRY.register("stoneward_shardplate_bondable_boots", StonewardShardplateBondableItem.Boots::new);
