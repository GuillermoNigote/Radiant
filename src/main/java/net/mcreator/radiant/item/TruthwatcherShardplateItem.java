...
public abstract class TruthwatcherShardplateItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("radiant:truthwatcher_shardplate"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public TruthwatcherShardplateItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends TruthwatcherShardplateItem {
		public Helmet() {
	...
	public static class Chestplate extends TruthwatcherShardplateItem {
		public Chestplate() {
	...
	public static class Leggings extends TruthwatcherShardplateItem {
		public Leggings() {
	...
	public static class Boots extends TruthwatcherShardplateItem {
		public Boots() {
